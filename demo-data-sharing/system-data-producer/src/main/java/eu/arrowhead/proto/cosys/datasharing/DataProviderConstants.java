...
public class DataProviderConstants {
    ...
    public static final String GET_PRODUCER_SERVICE_DEFINITION = "get-producer";
    ...
    //public static final String $PRESET_EVENT_TYPES_WD = "${" + PRESET_EVENT_TYPES + ":" + DEFAULT_PRESET_EVENT_TYPES + "}";
}
